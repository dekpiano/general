                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-9">
                                            ...
                                            <select class="form-select" id="pers_status" name="pers_status" required="">
                                                ...
                                                <option <?= $Pers->pers_status == $value?"selected":""?>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select" id="pers_prefix" name="pers_prefix" required="">
                                                ...
                                                <option <?= $Pers->pers_prefix == $value?"selected":""?>
                                                    value="<?=$value?>"><?=$value?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="pers_firstname"
                                                name="pers_firstname" placeholder="" value="<?=$Pers->pers_firstname?>"
                                                required="">
                                            <div class="invalid-feedback">
                                                กรุณากรอกชื่อจริง...
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="pers_lastname"
                                                name="pers_lastname" placeholder="" value="<?=$Pers->pers_lastname?>"
                                                required="">
                                            <div class="invalid-feedback">
                                                กรุณากรอกนามสกุล...
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control selectorEdit" id="pers_britday"
                                                name="pers_britday" placeholder="" value="<?=$Pers->pers_britday?>"
                                                autocomplete="off">
                                            <div class="invalid-feedback">
                                                กรุณาเลือกวันเกิด
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="tel" class="form-control" id="pers_phone" name="pers_phone"
                                                placeholder="" value="<?=$Pers->pers_phone?>">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select" id="pers_position" name="pers_position"
                                                ...
                                                <option <?= $Pers->pers_position == $value->posi_id?"selected":""?>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select" id="pers_learning" name="pers_learning">
                                                ...
                                                <option <?= $Pers->pers_learning == $value->lear_id?"selected":""?>
                                                    value="<?=$value->lear_id;?>">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select" id="pers_academic" name="pers_academic">
                                                ...
                                                <option <?= $Pers->pers_academic == $value?"selected":""?>
                                                    value="<?=$value;?>"><?=$value;?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select" id="pers_groupleade" name="pers_groupleade">
                                                ...
                                                <option <?= $Pers->pers_groupleade == $value?"selected":""?>
                                                    value="<?=$value;?>"><?=$value;?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <div class="invalid-feedback">
