...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1"><span class="text-muted fw-light">งานพัสดุและอุปกรณ์ /</span> ทะเบียนและสต็อกพัสดุ</h4>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        <div class="card-body p-3">
            <form method="GET" action="<?= base_url('Admin/Equipment/Manage') ?>" class="row g-2 align-items-center">
                <div class="col-md-4">
